        ...
        <div className="flex flex-col md:flex-row gap-8 items-start mb-12 w-full max-w-full">
          ...
          <div className="flex-grow pt-4 min-w-0">
            ...
            <div className="flex items-center gap-4">
              <Link to={`/play/${gameId}`} className="bg-theme-gradient text-white font-bold text-lg rounded-lg px-8 py-3 hover-glow transition-all shadow-lg transform hover:scale-105">{t('playNow')}</Link>
